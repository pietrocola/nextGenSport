...
public class ElencoTipologieCorsoDAO {
	...
	public static ElencoTipologieCorso loadElencoTipologieCorsoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (ElencoTipologieCorso) session.load(model.ElencoTipologieCorso.class, new Integer(ID));
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static ElencoTipologieCorso getElencoTipologieCorsoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (ElencoTipologieCorso) session.get(model.ElencoTipologieCorso.class, new Integer(ID));
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static ElencoTipologieCorso loadElencoTipologieCorsoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ElencoTipologieCorso) session.load(model.ElencoTipologieCorso.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static ElencoTipologieCorso getElencoTipologieCorsoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ElencoTipologieCorso) session.get(model.ElencoTipologieCorso.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static List queryElencoTipologieCorso(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From model.ElencoTipologieCorso as ElencoTipologieCorso");
		if (condition != null)
	...
	public static ElencoTipologieCorso createElencoTipologieCorso() {
		return new model.ElencoTipologieCorso();
	}
	
	public static boolean save(model.ElencoTipologieCorso elencoTipologieCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().saveObject(elencoTipologieCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean delete(model.ElencoTipologieCorso elencoTipologieCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().deleteObject(elencoTipologieCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean refresh(model.ElencoTipologieCorso elencoTipologieCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().getSession().refresh(elencoTipologieCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean evict(model.ElencoTipologieCorso elencoTipologieCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().getSession().evict(elencoTipologieCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);

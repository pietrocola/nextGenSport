...
public class ElencoDescrizioniCorsoDAO {
	...
	public static ElencoDescrizioniCorso loadElencoDescrizioniCorsoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (ElencoDescrizioniCorso) session.load(model.ElencoDescrizioniCorso.class, new Integer(ID));
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static ElencoDescrizioniCorso getElencoDescrizioniCorsoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (ElencoDescrizioniCorso) session.get(model.ElencoDescrizioniCorso.class, new Integer(ID));
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static ElencoDescrizioniCorso loadElencoDescrizioniCorsoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ElencoDescrizioniCorso) session.load(model.ElencoDescrizioniCorso.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static ElencoDescrizioniCorso getElencoDescrizioniCorsoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ElencoDescrizioniCorso) session.get(model.ElencoDescrizioniCorso.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static List queryElencoDescrizioniCorso(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From model.ElencoDescrizioniCorso as ElencoDescrizioniCorso");
		if (condition != null)
	...
	public static ElencoDescrizioniCorso createElencoDescrizioniCorso() {
		return new model.ElencoDescrizioniCorso();
	}
	
	public static boolean save(model.ElencoDescrizioniCorso elencoDescrizioniCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().saveObject(elencoDescrizioniCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean delete(model.ElencoDescrizioniCorso elencoDescrizioniCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().deleteObject(elencoDescrizioniCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean refresh(model.ElencoDescrizioniCorso elencoDescrizioniCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().getSession().refresh(elencoDescrizioniCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean evict(model.ElencoDescrizioniCorso elencoDescrizioniCorso) throws PersistentException {
		try {
			model.NextGenSport2PersistentManager.instance().getSession().evict(elencoDescrizioniCorso);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);

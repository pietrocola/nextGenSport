...
public class NextGenSport2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "NextGenSport2";
	...
	private NextGenSport2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new NextGenSport2PersistentManager();
		}
